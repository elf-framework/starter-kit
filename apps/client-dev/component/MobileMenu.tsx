...
import type { SidebarItemType } from "@elf-framework/ui";
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {mainMenus.map((it) => {
              const newIt = it as any;
              const selected = pathname.startsWith(newIt.category);
              ...
              return (
                ...
                >
                  {!selected ? (
                    ...
                    <div class="side-menu-item-title">{newIt.title}</div>
                  )}

                  {selected ? (
                    <Sidebar
                      items={menu}
                      hasSelected={(newIt: any) => {
                        return newIt.link === pathname;
                      }}
                    />
                  ) : undefined}
                </div>
